...
- Push Rohan to try interventions suggested (exercise, nutrition, mindfulness, labs).
- End-of-week tests conducted to review progress.
- Physician and Elyx team review test results and plan next steps.
- Member adherence ~50–60%, interventions attempted.
- Sarah may speak on behalf of Rohan to communicate with Ruby or other Elyx team members.
...
def generate_week12(start_date="2025-03-26", daily_min=12, daily_max=18, seed=1212):
    random.seed(seed)
    week_json = []
    system_prompt = build_system_prompt()

    # Week 12 → NOT a travel week
    travel_week = False
...
if __name__ == "__main__":
    data = generate_week12(start_date="2025-03-26")
    with open("elyx_week12_communications.json", "w", encoding="utf-8") as f:
        json.dump(data, f, indent=2, ensure_ascii=False)
    print("✅ Generated: elyx_week12_communications.json")
