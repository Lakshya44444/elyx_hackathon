...
def generate_week21(start_date="2025-05-29", daily_min=12, daily_max=18, seed=2021):
    random.seed(seed)
    week_json = []
...
if __name__ == "__main__":
    data = generate_week21(start_date="2025-05-29")
    with open("elyx_week21_communications.json", "w", encoding="utf-8") as f:
        json.dump(data, f, indent=2, ensure_ascii=False)
    print("✅ Generated: elyx_week21_communications.json")
