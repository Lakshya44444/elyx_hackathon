...
- Fortnightly medical team check-in this week (light review of records, guidance).
...
def generate_week11(start_date="2025-03-12", daily_min=12, daily_max=18, seed=1111):
    random.seed(seed)
    week_json = []
    system_prompt = build_system_prompt()

    # Week 11 → NOT a travel week
    travel_week = False
...
if __name__ == "__main__":
    data = generate_week11(start_date="2025-03-12")
    with open("elyx_week11_communications.json", "w", encoding="utf-8") as f:
        json.dump(data, f, indent=2, ensure_ascii=False)
    print("✅ Generated: elyx_week11_communications.json")
