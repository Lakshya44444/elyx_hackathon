...
def generate_week20(start_date="2025-05-22", daily_min=12, daily_max=18, seed=2020):
    random.seed(seed)
    week_json = []
...
if __name__ == "__main__":
    data = generate_week20(start_date="2025-05-22")
    with open("elyx_week20_communications.json", "w", encoding="utf-8") as f:
        json.dump(data, f, indent=2, ensure_ascii=False)
    print("✅ Generated: elyx_week20_communications.json")
