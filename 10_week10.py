...
def generate_week10(start_date="2025-03-05", daily_min=12, daily_max=18, seed=1010):
    random.seed(seed)
    week_json = []
    system_prompt = build_system_prompt()

    # Week 10 → NOT a travel week
    travel_week = False
...
if __name__ == "__main__":
    data = generate_week10(start_date="2025-03-05")
    with open("elyx_week10_communications.json", "w", encoding="utf-8") as f:
        json.dump(data, f, indent=2, ensure_ascii=False)
    print("✅ Generated: elyx_week10_communications.json")
