...
- Include travel if relevant (business trip scenario possible).
- Chronic condition: high sugar or high BP, based in Singapore.
Constraints:
...
def generate_week18(start_date="2025-05-08", daily_min=12, daily_max=18, seed=1818):
    random.seed(seed)
    week_json = []
...
if __name__ == "__main__":
    data = generate_week18(start_date="2025-05-08")
    with open("elyx_week18_communications.json", "w", encoding="utf-8") as f:
        json.dump(data, f, indent=2, ensure_ascii=False)
    print("✅ Generated: elyx_week18_communications.json")
